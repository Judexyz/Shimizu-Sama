...
const command = {
    ...
    execute: async (interaction) => {
        ...
        if (subCommand === 'create') {
            ...
            await GiveawayService.createGiveaway(guild, channel, interaction.member, prize, winners, endsAt, role?.id);
        }
        if (subCommand === 'end') {
